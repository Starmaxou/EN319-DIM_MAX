...
HD_PWD='/net/s/dpetitjean/Documents/Codesign_projectfiles/System/System.runs/design_1_mat_mult_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mat_mult_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mat_mult_0_0.tcl
